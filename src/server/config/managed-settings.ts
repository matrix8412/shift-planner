...
export const HTTPS_SETTINGS_KEY = "infra.https";

const managedSettingKeys = new Set([LEGACY_INSTALL_BANNER_SETTING_KEY, AI_SETTINGS_KEY, AI_AUDIT_RETENTION_DAYS_SETTING_KEY, BROWSER_NOTIFICATION_SETTINGS_KEY, NOTIFICATION_SETTINGS_KEY, PUSH_SUBSCRIPTIONS_SETTING_KEY, HTTPS_SETTINGS_KEY]);
